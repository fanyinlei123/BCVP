...
*********************************************************
# Tips: 
1. BCVP.FrameWork project is a simple implementation of generating files using T4 templates.
...
1, in the BCVP.Repository layer under the Sugar folder under the BaseDBConfig.cs, configure their own strings
``` 
...
```
2, in the BCVP.FrameWork layer of the dbhelper.ttinclude, configure their own strings
``` 
...
Blog Park: https://www.cnblogs.com/laozhang-is-phi/
 ...
 Code Cloud: Https://gitee.com/laozhangIsPhi/BCVP
