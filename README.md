...
[![Gitter](https://badges.gitter.im/Blog_core/community.svg)](https://gitter.im/Blog_core/community?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)  [![sdk](https://img.shields.io/badge/sdk-3.0-d.svg)](#)  [![Build status](https://ci.appveyor.com/api/projects/status/facdw9pinrxs1610?svg=true)](https://ci.appveyor.com/project/anjoy8/blog-core) [![codecov](https://codecov.io/gh/anjoy8/BCVP/branch/master/graph/badge.svg)](https://codecov.io/gh/anjoy8/BCVP)  [![License MIT](https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square)](https://github.com/anjoy8/BCVP/blob/master/LICENSE) [![Language](https://img.shields.io/badge/language-csharp-d.svg)](#) 
[![star this repo](https://badgen.net/github/stars/anjoy8/bcvp)](https://github.com/anjoy8/bcvp)
[![fork this repo](https://badgen.net/github/forks/anjoy8/bcvp)](https://github.com/anjoy8/bcvp/fork) 
...
[ENGLISH](https://github.com/anjoy8/BCVP/blob/master/README-en.md) | [中文版](https://github.com/anjoy8/BCVP/blob/master/README.md)

![Logo](https://github.com/anjoy8/BCVP/blob/master/BCVP/wwwroot/logocore.png)
...
![系统架构图](https://github.com/anjoy8/BCVP/blob/master/BCVP.System.Architecture.png)
...
![系统压测结果报告](https://github.com/anjoy8/BCVP/blob/master/BCVP/wwwroot/JMeterTest.png)
...
数据查看：[BCVP.Data.json](https://github.com/anjoy8/Blog.Data.Share/tree/master/BCVP.Data.json)
...
![操作流程](https://github.com/anjoy8/BCVP/blob/master/BCVP/wwwroot/operateFlow.gif)
...
| ------- | -------- | ------- |
| [BCVP.Webapi.Template](https://www.nuget.org/packages/BCVP.Webapi.Template/) | [![BCVP.Webapi.Template](https://img.shields.io/nuget/v/BCVP.Webapi.Template.svg)](https://www.nuget.org/packages/BCVP.Webapi.Template/)  | [![BCVP.Webapi.Template](https://img.shields.io/nuget/dt/BCVP.Webapi.Template.svg)](https://www.nuget.org/packages/BCVP.Webapi.Template/) |
...
|[NetCore-Sugar-Demo](https://github.com/anjoy8/NetCore-Sugar-Demo)|[Blog.SplRepository.Demo](https://github.com/anjoy8/Blog.SplRepository.Demo)|[BCVP](https://github.com/anjoy8/BCVP)|[ChristDDD](https://github.com/anjoy8/ChristDDD)|
...
1【重要】、BCVP.FrameWork 项目是用T4模板生成文件的简单实现。如果有错误，可以联系我，
QQ群：867095512
...
在BCVP层中的 appsettings.json 中开启 SeedDBEnabled：true 即可。
...
在BCVP 项目下的 wwwroot 文件夹中BCVP.Table.sql（表结构）、BCVP.Table&Data.sql（结构和数据）。
或者来群里，群文件的是最新的。
（目前不支持 sql 文件了，忙不过来，可以来群里，找群友要一份，建议使用 seeddata ）


6、如果想单独查看关于【JWT授权】的相关内容，可以访问 https://github.com/anjoy8/BlogArti/tree/master/BCVP_JWT，
   我单拎出来的一个demo。


7、项目后期发布的时候可以有两个办法，一种是dotnet的kestrel部署，另一种是 IIS 发布部署，但是在发布的时候，
因为解耦了，所以会导致无法把 service.dll & repository.dll 拷贝到生成目录下，大家可以采用：
BCVP -> 属性 -> Build Events -> Post-build event command ->>>>

Copy "$(ProjectDir)bin\Debug\netcoreapp2.2\" "$(SolutionDir)BCVP\bin\Debug\"
...
1、在BCVP层 appsettings.json 中，配置自己的字符串，注意优先级是从上往下的，只能设置一个true
...
```
A、BCVP 层 appsettings.json 中配置
B、T4 模板 BCVP.FrameWork -> DbHelper.ttinclude

```

3、如果想使用T4模板，在BCVP.FrameWork层的DbHelper.ttinclude 中，配置自己的字符串
...
博客园：https://www.cnblogs.com/laozhang-is-phi/
 ...
 码云：https://gitee.com/laozhangIsPhi/BCVP
